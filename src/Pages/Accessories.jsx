...
function Accessories() {
  ...
  console.log("Path in ACCESSORIES", path);
  ...
  return (
    <div className={`mb-14 lg:mb-0 ${darkMode ? "text-white" : ""}`}>
      <>
        ...
        <div
          className={`${
            showCart
              ...
              : "hidden"
          } fixed   h-full border-gray-200 border-opacity-75 opacity-96 top-0 right-0 max-h-lvh w-full lg:w-[30rem]   transition-transform`}
        >
        ...
        <div
          className=" z-50 mt-1 flex flex-wrap gap-3 w-full md:w-72   
         p-5     "
        >
          {/* <Slider {...settings}> */}
