...
//       return (
//         <a>
//           <img src={`${images[0]}/abstract0${i + 1}.jpg`} />
//         </a>
//       );
//     },
//     dots: true,
...
//   };
//   return (
//     <div className={`${darkMode ? "bg-black text-white" : ""} mb-14 full`}>
//       <>
//         <Navbar
//           showCart={showCart}
...
//                 }`
//               : "hidden"
//           } fixed    border-gray-200 border-opacity-75 opacity-96 top-0 right-0 h-lvh w-full lg:w-[30rem]  bg-white transition-transform}`}
//         >
//           <Wishlist
//             showWishlist={showWishlist}
//             setShowWishlist={setShowWishlist}
...
//     {item.images?.map((ele) => {
//       return (
//         <div className=" slider-container box-border overflow-hidden">
//           <Slider {...settings}>
//             <div>
//               <img
//                 alt="product_image"
...
//                 selectedDetailsofProductForOrder.pincode
//               ) ? (
...
//                 <div>
//                   <p className="absolute top-5  font-bold text-lg bg-slate-300 w-2/3 text-center">
//                     ORDER DETAILS
//                   </p>
